...
public:
    ...
    // When enabled, direct callers that arrive while another FT QSO is active
    // are kept in a passive FIFO. Only one QSO is ever active/transmitted at a time.
    bool ft8QueueCallers = false;
