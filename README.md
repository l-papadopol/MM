...
0.5.76u is a packaging-only release line: Windows release artifacts are MXE static legacy/AVX2 builds produced by GitHub, macOS bundles are checked for missing Qt frameworks, and Linux emits a single tar.gz. No modem/DSP/CAT/audio/MIND runtime retune is intended.
