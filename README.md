...
This source package includes a macOS CI hotfix for Qt6/AppleClang QChar relational comparisons in the MSHV pack/unpack ports, plus the previous GitHub Actions hardening for Windows/MSYS2 and macOS unsigned distribution builds.
