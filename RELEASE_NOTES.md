...
The unified Settings workbench now lazy-loads heavy pages such as Rotator, MM Flow Studio, Scheduler and Soundcard calibration. The log prints open timing diagnostics.
