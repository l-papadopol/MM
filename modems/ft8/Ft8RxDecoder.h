...
public slots:
    ...
    void setQsoDeadlineActive(bool active);
...
private:
    ...
    QVector<Candidate> findFt4DeadlineCandidates(const QVector<double> &samples,
                                                 int centerHz,
                                                 int halfSpanHz,
...
private:
    ...
    QString m_myCall;
    QString m_dxCall;
    std::atomic<bool> m_qsoDeadlineActive {false};
