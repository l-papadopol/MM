...
package_variant() {
    ...
    # windeployqt copies Qt DLLs/plugins but can leave indirect MSYS2/MinGW
    # dependencies behind. Bundle and verify the complete runtime closure before
    # the ZIP is created, otherwise the release artifact is not standalone.
