...
# still points to an older commit, producing packages from an older release.
...
# 0.5.9. The full release identity (including -alpha) is MADMODEM_PACKAGE_VERSION / this file.
printf '  status               : OK\n'
