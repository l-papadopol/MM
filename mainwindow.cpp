...
void MainWindow::setupFt8Page()
{
    ...
    QGroupBox *clockGroup = new QGroupBox(uiText("ft_period_clock", "UTC / FT periods"), m_pageFt8Settings);
    ...
    m_lblFt8PeriodStatus->setWordWrap(true);
    ...
    clockLayout->addWidget(m_lblFt8PeriodStatus);
...
void MainWindow::updateFt8SlotStatus()
{
    ...
    if (m_lblFt8PeriodStatus != nullptr) {
        const QString slotText = QString::number(static_cast<double>(slotMs) / 1000.0,
                                                 'f', slotMs % 1000 == 0 ? 0 : 1);
        const QString cycleText = QString::number(static_cast<double>(cycleMs) / 1000.0,
                                                  'f', cycleMs % 1000 == 0 ? 0 : 1);
        m_lblFt8PeriodStatus->setText(QStringLiteral("I: 0–%1 s   |   II: %1–%2 s")
                                         .arg(slotText, cycleText));
    }
