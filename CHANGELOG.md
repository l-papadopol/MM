...
## 0.5.76q - macOS Qt6 QTextStream UTF-8 encoding fix
...
## 0.5.76q - macOS Qt6 QChar control-code conversion fix
...
## 0.5.76q - macOS Qt6 qint64 min/max overload fix
...
## 0.5.76q - macOS Qt6 QString::midRef removal
...
## 0.5.76q - GitHub CI macOS broad portability hardening
...
## 0.5.76q - macOS Qt6 QRegExp removal fix
...
## 0.5.76q - macOS Qt6/MSHV QChar build fix
...
## 0.5.76q - GitHub CI Windows/macOS hardening
