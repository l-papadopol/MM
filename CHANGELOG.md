## MadModem 0.5.0-alpha.13 — Rotator band assignment guard

- Fixed rotator profile selection: when the current band is known, MM no longer falls back to the active rotator profile if no profile is assigned to that band.
- A rotator assigned only to 2 m will now remain disabled on 20 m and other unassigned bands.
- The Rotator status line now reports `Rotator: disabled for current band ...` when this band guard is active.

## MadModem 0.5.0-alpha.13 — Navball lower text cleanup
...
## MadModem 0.5.0-alpha.13 — Rotator setpoint layout and tooltips
...
## MadModem 0.5.0-alpha.13 — compact Rotator tab layout
...
## MadModem 0.5.0-alpha.13 — rotator compile fix and navball bezel
...
## MadModem 0.5.0-alpha.13 — Navball icon styling and sparse elevation scale
...
## MadModem 0.5.0-alpha.13 — Navball live Sun/Moon overlay
...
## MadModem 0.5.0-alpha.13 — GitHub source-origin README cleanup
...
## MadModem 0.5.0-alpha.13 — Moon / EME rotator tracking
