...
// 0.5.76k fixes macOS Qt6 removal of QRegExp in active MSHV sources
...
#define MADMODEM_VERSION_STRING "0.5.76k"
#define MADMODEM_VERSION_DISPLAY "MadModem 0.5.76k"
