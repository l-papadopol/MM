...
// 0.5.76o fixes Qt6/AppleClang qBound/qMax/qMin qint64 overload ambiguity and extends macOS CI preflight
...
#define MADMODEM_VERSION_STRING "0.5.76o"
#define MADMODEM_VERSION_DISPLAY "MadModem 0.5.76o"
