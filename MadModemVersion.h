...
// 0.5.76y hardens GitHub release asset cleanup and package self-checks
...
#define MADMODEM_VERSION_PRERELEASE "y"
#define MADMODEM_VERSION_STRING "0.5.76y"
#define MADMODEM_VERSION_DISPLAY "MadModem 0.5.76y"
