...
// 0.5.76u hardens GitHub release asset cleanup and package self-checks
...
#define MADMODEM_VERSION_PRERELEASE "u"
#define MADMODEM_VERSION_STRING "0.5.76u"
#define MADMODEM_VERSION_DISPLAY "MadModem 0.5.76u"
