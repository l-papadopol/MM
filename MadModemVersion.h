...
// 0.5.76 final keeps the validated packaging and the shutdown
// lifecycle fix. It does not change
// modem/DSP/CAT decoder logic.
...
#define MADMODEM_VERSION_STRING "0.5.76"
#define MADMODEM_VERSION_DISPLAY "MadModem 0.5.76"
