...
// 0.5.76m completes active MSHV Qt6/macOS midRef cleanup and CI preflight
...
#define MADMODEM_VERSION_STRING "0.5.76m"
#define MADMODEM_VERSION_DISPLAY "MadModem 0.5.76m"
