...
// 0.5.76q fixes Qt6 QTextStream UTF-8 encoding API removal in the logbook export path and extends macOS CI preflight
...
#define MADMODEM_VERSION_STRING "0.5.76q"
#define MADMODEM_VERSION_DISPLAY "MadModem 0.5.76q"
