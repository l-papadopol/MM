...
// 0.5.76p fixes Qt6 QTextStream UTF-8 encoding API removal in the logbook export path and extends macOS CI preflight
...
#define MADMODEM_VERSION_PRERELEASE "o"
#define MADMODEM_VERSION_STRING "0.5.76p"
#define MADMODEM_VERSION_DISPLAY "MadModem 0.5.76p"
