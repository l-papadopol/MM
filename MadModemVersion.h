...
// 0.5.76v hardens GitHub release asset cleanup and package self-checks
...
#define MADMODEM_VERSION_STRING "0.5.76v"
#define MADMODEM_VERSION_DISPLAY "MadModem 0.5.76v"
