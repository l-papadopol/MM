      ...
      m_schedulerTranslator(std::move(schedulerTranslator))
{
    ...
    m_tabs->addTab(makeAppearancePage(), L(QStringLiteral("Appearance / UI")));
...
void AppSettingsDialog::setInitialPage(InitialPage page)
{
    ...
    case InitialPage::Appearance: index = 1; break;
    case InitialPage::UserQthMacros: index = 2; break;
    case InitialPage::Logbook: index = 3; break;
    case InitialPage::Rotator: index = 4; break;
    case InitialPage::AutoQsoFlow: index = m_autoQsoFlowTabIndex; break;
    case InitialPage::Scheduler: index = 6; break;
    case InitialPage::SoundCardCalibration: index = 7; break;
    }
