...
public slots:
    ...
    void setRotatorConnectionStatus(int profileIndex, bool connected, const QString &message);
...
signals:
    ...
    void rotatorConnectionRequested(int profileIndex, bool connectRequested);
...
private:
    ...
    QWidget *makeDeferredSettingsPage(const QString &title);
    QWidget *buildSettingsPage(InitialPage page);
    int addSettingsTab(InitialPage page, const QString &title, bool buildNow);
    void ensureSettingsTabBuilt(int index);
    ...
    void applyStoredRotatorConnectionStatuses();
    ...
    QCheckBox *m_chkUsePreciseCoordinates = nullptr;
    QDoubleSpinBox *m_spinMyLatitude = nullptr;
    QDoubleSpinBox *m_spinMyLongitude = nullptr;
    ...
    QHash<int, InitialPage> m_deferredSettingsTabs;
    ...
    QSpinBox *m_spinUiFontSize = nullptr;
    QComboBox *m_comboDecodeTablePreset = nullptr;
    QComboBox *m_comboDecodeTableFontFamily = nullptr;
