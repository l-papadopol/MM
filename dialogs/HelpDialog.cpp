...
constexpr const char *kHelpNamespacePrefix = "org.madmodem.mm.050a1";
constexpr const char *kHelpVersion = MADMODEM_VERSION_STRING;
...
const FallbackTopic kFallbackTopics[] = {
    ...
    {"mm_flow_studio", "mm_flow_studio.html"},
    {"evil_mode", "evil_mode.html"},
...
QString HelpDialog::localizedTopicTitle(const QString &topicKey) const
{
    ...
    static const QMap<QString, QMap<QString, QString>> titles = {
        {QStringLiteral("en"), {
            ...
            {QStringLiteral("scheduler"), QStringLiteral("Rotator / Scheduler")},
            {QStringLiteral("mm_flow_studio"), QStringLiteral("MM Flow Studio")},
            {QStringLiteral("evil_mode"), QStringLiteral("Evil mode / automation")},
        ...
        {QStringLiteral("it"), {
            ...
            {QStringLiteral("cw"), QStringLiteral("CW / Morse")},
            {QStringLiteral("ft8_ft4"), QStringLiteral("FT4 / FT8")},
            {QStringLiteral("rotator"), QStringLiteral("Rotatore")},
            {QStringLiteral("scheduler"), QStringLiteral("Rotore / Scheduler")},
            {QStringLiteral("mm_flow_studio"), QStringLiteral("MM Flow Studio")},
            {QStringLiteral("evil_mode"), QStringLiteral("Evil mode / automazione")},
        ...
        {QStringLiteral("fr"), {
            ...
            {QStringLiteral("scheduler"), QStringLiteral("Rotateur / Scheduler")},
            {QStringLiteral("mm_flow_studio"), QStringLiteral("MM Flow Studio")},
            {QStringLiteral("evil_mode"), QStringLiteral("Evil mode / automatisation")},
        ...
        {QStringLiteral("de"), {
            ...
            {QStringLiteral("scheduler"), QStringLiteral("Rotor / Scheduler")},
            {QStringLiteral("mm_flow_studio"), QStringLiteral("MM Flow Studio")},
            {QStringLiteral("evil_mode"), QStringLiteral("Evil mode / Automatisierung")},
        ...
        {QStringLiteral("no"), {
            ...
            {QStringLiteral("scheduler"), QStringLiteral("Rotor / Scheduler")},
            {QStringLiteral("mm_flow_studio"), QStringLiteral("MM Flow Studio")},
            {QStringLiteral("evil_mode"), QStringLiteral("Evil mode / automatisering")},
        ...
        {QStringLiteral("cs"), {
            ...
            {QStringLiteral("scheduler"), QStringLiteral("Rotátor / Scheduler")},
            {QStringLiteral("mm_flow_studio"), QStringLiteral("MM Flow Studio")},
            {QStringLiteral("evil_mode"), QStringLiteral("Evil mode / automatizace")},
