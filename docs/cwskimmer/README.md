...
current MadModem 0.5.8 source checkpoint. The active design separates exact-tone
...
See `../CW_ADAPTIVE_BEAM_DECODER_0_5_78.md` for the current checkpoint details.
