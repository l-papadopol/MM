...
The standalone CatRotator WSJT-X/AirScout/PreviSat UDP tracking model is intentionally not carried into the integrated MM UI. In MadModem, rotator tracking is driven by MM's selected QSO target and manual operator commands.
