...
## 0.5.78 cleanup status

The retired MIND integration is not part of the active FT8 decoder source. Historical MIND-related audits were moved to `docs/history/audits/`. Test media and MM Flow Studio are not included in the production source package.
